    ...
    return (
        <div className='finddoctor'>
            <center>
                ...
                <div>               <i style={{color:'#177056',fontSize:'20rem'}} className="fa fa-user-md"></i>
                    ...
                    {/* <p>Perform a search to see the results.</p> */}
                        ...
                        <div className="findiconimg"><img className='findIcon' src="grihf-frontend_capstone_starter_code\public\1690923295547doctor1.PNG" alt=""/></div>
                        <div className="search-doctor-input-results" hidden={doctorResultHidden}>
                            {
                                specialities.map(speciality => <div className="search-doctor-result-item" key={speciality} onMouseDown={() => handleDoctorSelect(speciality)}>
                                    <span><img src="grihf-frontend_capstone_starter_code\public\1690923295547doctor1.PNG" alt="" style={{height:"10px", width:"10px"}} width="12" /></span>
